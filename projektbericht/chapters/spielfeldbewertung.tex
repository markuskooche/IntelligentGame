...
Um diese Aussage adequate zu best\"atigen werden vier weitere Karten (siehe Abbildung~\ref{fig:additional-statistic-maps}) aufgef\"uhrt, bei denen erneut Tests durchgef\"uhrt werden.
...
Dabei wird als erster Spieler der triviale Client verwendet, welcher zu Beginn des Semesters jedem Team ausgeh\"andigt wird.
...
\begin{figure}
    ...
    \qquad
    \subfloat[Karte: QR]{ \includegraphics[width=0.5\linewidth]{pics/maps/qr} }
    \qquad
...
\begin{table}[!h]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Weitere Karten mit den Suchalgorithmen (Ergebnisse wurden geglättet)}
